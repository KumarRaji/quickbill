-- Complete QuickBill Database Schema
...
-- 4) PURCHASE INVOICES TABLE (Must be created before stock table due to foreign key)
...
-- 13) PURCHASE RETURN AUDIT TABLE
